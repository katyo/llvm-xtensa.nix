...
, llvm_10_xtensa, darwin, git, cmake, rust, rustPlatform
, pkgconfig, openssl
, which, libffi
...
let
  ...
  llvmSharedForBuild = pkgsBuildBuild.llvm_10_xtensa.override { enableSharedLibraries = true; };
  llvmSharedForHost = pkgsBuildHost.llvm_10_xtensa.override { enableSharedLibraries = true; };
  llvmSharedForTarget = pkgsBuildTarget.llvm_10_xtensa.override { enableSharedLibraries = true; };

  # For use at runtime
  llvmShared = llvm_10_xtensa.override { enableSharedLibraries = true; };
